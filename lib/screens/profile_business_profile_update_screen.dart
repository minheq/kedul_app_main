...
class ProfileBusinessProfileUpdateScreenData {
  final Business business;

  ProfileBusinessProfileUpdateScreenData({this.business});
}
...
class _ProfileBusinessProfileUpdateScreenState
  ...
  UpdateBusinessInput input = UpdateBusinessInput();
  bool _isSubmitting = false;
  String _status;
  String _businessID;

  Future<ProfileBusinessProfileUpdateScreenData> initData() async {
    ...
    return ProfileBusinessProfileUpdateScreenData(business: business);
  }
  ...
  Future<void> handleSubmit() async {
    ...
    try {
      ...
      await businessModel.updateBusiness(_businessID, input);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: FutureBuilder(
          future: initData(),
          builder: (context,
              AsyncSnapshot<ProfileBusinessProfileUpdateScreenData> snapshot) {
